...
flies = ['fly01', 'fly02', 'fly03', 'fly04', 'fly05'] # set to None, or a list of fly dirs in dataset_path
nodes = 2 # 1 or 2
...
dataset_path = "/oak/stanford/groups/trc/data/Alex/imports/220218"
